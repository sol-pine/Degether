...
export const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=${REACT_APP_NAVER_CLIENT_ID}&state=${REACT_APP_NAVER_STATE}&redirect_uri=${REACT_APP_NAVER_REDIRECT_URL}`;
export const GOOGLE_AUTH_URL = `https://accounts.google.com/o/oauth2/v2/auth/oauthchooseaccount?&scope=https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile&access_type=offline&redirect_uri=${REACT_APP_GOOGLE_REDIRECT_URL}&response_type=code&client_id=${REACT_APP_GOOGLE_CLIENT_ID}`;
