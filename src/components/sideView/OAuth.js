import { REACT_APP_KAKAO_REDIRECT_URL } from "../../shared/api";

export const KAKAO_AUTH_URL = `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.REACT_APP_KAKAO_CLIENT_ID}&redirect_uri=${REACT_APP_KAKAO_REDIRECT_URL}&response_type=code`;
